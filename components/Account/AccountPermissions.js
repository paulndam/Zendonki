...
function UserPermission({ user }) {
  ...
  // created when component mounts, only lets the toggle effect to run once we hit or toggel the effect of changing roles
  ...
  return (
    <Table.Row>
      <Table.Cell>
        <Checkbox checked={admin} toggle onChange={changePermission} />
      </Table.Cell>
